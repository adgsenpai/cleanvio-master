...
print("CLEANVID REMASTERED BY CLEANVIO - ADG STUDIOS")
...
path = os.path.dirname(os.path.realpath(__file__))+'\output.mp4'
print(path)
subprocess.call([os.path.dirname(os.path.realpath(__file__))+'\PlayerUI.exe', path])
